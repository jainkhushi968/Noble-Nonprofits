            ...
            <div class="row">
                <div class="col-md-4 offset-md-4"> 
                    <div class="card mt-4" style="margin-bottom: 14%">
                        ...
                        <%      String PassMsg = (String) session.getAttribute("pass-success");

                            if (PassMsg != null) {%>
                        <div class="alert alert-success" role="alert"><%= PassMsg%> For Login <a href="LoginVol.jsp"> Click Here </a></div> 


                        <%
                                session.removeAttribute("pass-success");
                            }
                        %>

                        <%
                            String failMsg = (String) session.getAttribute("failed-pass");
                        ...
                        <%
                                session.removeAttribute("failed-pass");
                        ...
                        <div class="card-body">
                            <form action="ForgetPass_Vol" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="newpassword" class="form-control" id="exampleInputPassword1" pattern=".{8,14}" placeholder="Enter New Password" required title="8-14 characters">
                                </div>


                                <div class="form-group">
                                    <label for="exampleInputPassword1"> Confirm Password</label>
                                    <input type="password" name="conpassword" class="form-control" id="exampleInputPassword1" pattern=".{8,14}" placeholder="Enter Confirm Password" required title="8-14 characters">
                                </div>
