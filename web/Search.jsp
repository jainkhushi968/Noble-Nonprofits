<%-- 
    Document   : Search
    Created on : Apr 8, 2021, 2:05:06 PM
...
<html>
    ...
    <center>
        ...
        <table class="table table-custom" style="margin-bottom: 14%">
            <thead class="thead" style="font-size: 20px ; background-color: #104370 ">
                <tr>
                    <th scope="col">#</th>
            ...
            <tr>
                ...
                <td><a href="http://<%=rs.getString("wesite")%>"><%=rs.getString("wesite")%></a></td>
