                        ...
                        <div class="card-body">
                            <form action="ForgetPass_NPO" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="newpass" class="form-control" id="exampleInputPassword1" placeholder="Enter New Password"  pattern=".{8,14}" required title="8-14 characters">
                                </div>


                                <div class="form-group">
                                    <label for="exampleInputPassword1"> Confirm Password</label>
                                    <input type="password" name="conpass" class="form-control" id="exampleInputPassword1" placeholder="Enter Confirm Password"  pattern=".{8,14}" required title="8-14 characters">
                                </div>
