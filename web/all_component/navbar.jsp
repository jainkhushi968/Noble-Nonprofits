...
<nav class="navbar navbar-expand-lg navbar-light navbar-custom" style="background-color: #e0f7fa;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto" id="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="ApplyVol.jsp"><i class="fa fa-hand-o-up" aria-hidden="true"></i> Apply for Volunteering </a>
            </li>
        </ul>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <a href="http://<%=rs.getString(3)%>"><%= rs.getString(3)%></a> </td>
