<%-- 
    Document   : Login
    Created on : Apr 5, 2021, 2:24:29 AM
            ...
            <div class="row">
                <div class="col-md-4 offset-md-4"> 
                    <div class="card mt-4">
                        ...
                        <%                             String withoutVolLogin = (String) session.getAttribute("Login-error-npo");
                            if (withoutVolLogin != null) {%>
                        <div class="alert alert-danger" role="alert"><%=withoutVolLogin%></div> 
                        <%
                                session.removeAttribute("Login-error-npo");
                            }
                        ...
                        <div class="card-body">
                            <form action="NPOLoginServlet" method="post">
                            ...
                            <a class="dropdown-item" href="ForgotPass_NPO.jsp">Forgot password?</a>
                        </div>
                    </div>
                </div>
            </div>
